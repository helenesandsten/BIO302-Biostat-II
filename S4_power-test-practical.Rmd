...
Fish typically have a mass of 1kg with a standard deviation of 0.2kg. The scientist hopes that the new food will give at least 0.1kg extra mass (otherwise it is not worth the extra cost). <br>
...
# Two-sample t test power calculation 
library("pwr")
pow <- pwr.anova.test(d = 0.5, # effect size
                  sig.level = 0.05, 
                  power = 0.8) 
pow
plot(pow)
